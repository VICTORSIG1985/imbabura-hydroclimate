    ...
    <>
      ...
      <section id="kpis" className="section section-tinted">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
          <KPIBox locale={locale} label={t('kpi_period')}    value={t('kpi_period_value')}   sub={t('kpi_period_sub')}    explainKey="period" />
          <KPIBox locale={locale} label={t('kpi_warming')}   value={t('kpi_warming_value')}  sub={t('kpi_warming_sub')}   accent="red"   explainKey="warming" />
          <KPIBox locale={locale} label={t('kpi_enso')}      value={t('kpi_enso_value')}     sub={t('kpi_enso_sub')}      accent="blue"  explainKey="enso" />
          <KPIBox locale={locale} label={t('kpi_cmip6')}     value={t('kpi_cmip6_value')}    sub={t('kpi_cmip6_sub')}     accent="amber" explainKey="cmip6" />
          <KPIBox locale={locale} label={t('kpi_lapse')}     value={t('kpi_lapse_value')}    sub={t('kpi_lapse_sub')}     accent="green" explainKey="lapse" />
          <KPIBox locale={locale} label={t('kpi_extremes')}  value={t('kpi_extremes_value')} sub={t('kpi_extremes_sub')}  accent="blue"  explainKey="extremes" />
        </div>
      </section>
